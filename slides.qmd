...
-   Work with larger-than-memory data in R without needing to set up a cluster or database

-   Work with multifile datasets as if they were 1 dataset

-   Interoperability

## The Arrow format - columnar data spec

![](https://arrow.apache.org/img/simd.png)

## The Arrow format - standardisation
...
* use dplyr verbs to manipulate your data
* lots of functions implemented to
